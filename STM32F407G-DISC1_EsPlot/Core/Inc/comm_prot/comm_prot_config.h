...
#define N_RX_SIGNALS 		1			//number of the used rx signals
...
#define PROCESS_FREQUENCY	1000		//in Hz, frequency of the process which triggers the communication (e.g. timer interrupt frequency)

#define COMM_DEV_BAUDRATE	4500000	    //in Baud/s, transfer speed of the used communication device
